...
function finalizarCompra() {
    ...
    alert(
        "Gracias por tu compra en Brillo Natural. " +
...
function enviarMensaje() {
    ...
    let respuesta =
        "Gracias por escribirnos. Un asesor de Brillo Natural puede ayudarte.";
    ...
    if (
        ...
        respuesta =
            "Tenemos bases, correctores, rubores, contornos y otros productos de belleza.";
